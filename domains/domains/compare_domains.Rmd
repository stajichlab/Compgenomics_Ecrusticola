...
```{r}
# Define mer4 and mer.up.plt in a single code block
...
# Save the plots
ggsave(file="plots/MEROPS_Down.png", plot=mer.down.plt, width=11, height=10, dpi=300)
ggsave(file="plots/MEROPS_Up.svg", plot=mer.up.plt, width=11, height=10)
ggsave(file="plots/MEROPS_Down.png", plot=mer4, width=11, height=10, dpi=300)
